...
@section('content')
    <div class="my-10">
        <span class="text-center font-bold text-2xl">Edit Form</span>
    </div>
    <form action="{{ route('crud.update', ['crud' => $crud->id]) }}" method="post">
        ...
        <div class="flex flex-col gap-4">
            <div>
                ...
                <input type="text" id="nama" name="nama" value="{{ $crud->nama }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Nama" required />
            </div>
            <div>
                <div class="flex items-center mb-4">
                    <input id="default-radio-1" {{ $crud->is_active ? 'checked' : '' }} type="radio" value="1"
                        name="is_active"
                ...
                <div class="flex items-center">
                    <input {{ $crud->is_active ? '' : 'checked' }} id="default-radio-2" type="radio" value="0"
                        name="is_active"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
